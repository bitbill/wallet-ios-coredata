#
#  Be sure to run `pod spec lint BitRecord.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Squirrel" => "mast@bitbill.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/bitbill/wallet-ios-coredata.git", :tag => "#{s.version}" }
